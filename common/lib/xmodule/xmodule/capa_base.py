...
class CapaFields(object):
    ...
    saved_answers = Boolean(help=_("Whether or not the answers have been saved since last submit"),
                            scope=Scope.user_state)
...
class CapaMixin(CapaFields):
    ...
    def set_state_from_lcp(self):
        ...
        self.saved_answers = lcp_state['saved_answers']
